#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/simplemodels/dnasesignal/wgEncodeOpenChromDnaseHek293tSig/windowsize1000.max")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/simplemodels/dnasesignal/wgEncodeOpenChromDnaseHek293tSig/windowsize1000.avg")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/simplemodels/dnasesignal/wgEncodeOpenChromDnaseHek293tSig/windowsize500.max")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/simplemodels/dnasesignal/wgEncodeOpenChromDnaseHek293tSig/windowsize500.avg")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/simplemodels/dnasesignal/wgEncodeOpenChromDnaseHek293tSig/windowsize300.max")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/simplemodels/dnasesignal/wgEncodeOpenChromDnaseHek293tSig/windowsize300.avg")
...
# set column names
mydata.GCH_1<-cbind(mydata.GCH_1[,1:3],log(mydata.GCH_1[,4]),log(mydata.GCH_1[,5]+0.1))
colnames(mydata.GCH_1)<-c("chrom", "start", "end", "Methyl_transform", "DNase_transform")
...
model_1<-lm(Methyl_transform~DNase_transform,data=mydata.GCH_1)
...
# the coefficient of log(ChIP+0.1)
a_2<-round(model_1$coefficients[2],3)
a_3<-round(model_1$coefficients[1],3)
n=dim(mydata.GCH_1)[1]
# combine
if(a_3<0){result1<-paste0("Methyl_transform=",a_2,"XDNase_transform",a_3,"; R^2=",result_r.squared,"; n=",n)}else{result1<-paste0("Methyl_transform=",a_2,"XDNase_transform+",a_3,"; R^2=",result_r.squared,"; n=",n)}
...
# set column names
mydata.WCG_2<-cbind(mydata.WCG_2[,1:3],log(mydata.WCG_2[,4]),log(mydata.WCG_2[,5]+0.1))
colnames(mydata.WCG_2)<-c("chrom", "start", "end", "Methyl_transform", "DNase_transform")
# remove x-axis cutoff < -10
mydata.WCG_2<-mydata.WCG_2[with(mydata.WCG_2,mydata.WCG_2$Methyl_transform>-10),]
# Estimation of regression parameters
# fit linear models and carry out regression
model_2<-lm(Methyl_transform~DNase_transform,data=mydata.WCG_2)
# Obtain predicted and residual values and draw figures
...
# combine
if(a_3<0){result2<-paste0("Methyl_transform=",a_2,"XDNase_transform",a_3,"; R^2=",result_r.squared,"; n=",n)}else{result2<-paste0("Methyl_transform=",a_2,"XDNase_transform+",a_3,"; R^2=",result_r.squared,"; n=",n)}
...
# set column names
mydata.GCH_3<-cbind(mydata.GCH_3[,1:3],log(mydata.GCH_3[,4]),log(mydata.GCH_3[,5]+0.1))
colnames(mydata.GCH_3)<-c("chrom", "start", "end", "Methyl_transform", "DNase_transform")
# remove x-axis cutoff < -10
mydata.GCH_3<-mydata.GCH_3[with(mydata.GCH_3,mydata.GCH_3$Methyl_transform>-10),]
# Estimation of regression parameters
# fit linear models and carry out regression
model_3<-lm(Methyl_transform~DNase_transform,data=mydata.GCH_3)
# Obtain predicted and residual values and draw figures
...
# combine
if(a_3<0){result3<-paste0("Methyl_transform=",a_2,"XDNase_transform",a_3,"; R^2=",result_r.squared,"; n=",n)}else{result3<-paste0("Methyl_transform=",a_2,"XDNase_transform+",a_3,"; R^2=",result_r.squared,"; n=",n)}
...
# set column names
mydata.WCG_4<-cbind(mydata.WCG_4[,1:3],log(mydata.WCG_4[,4]),log(mydata.WCG_4[,5]+0.1))
colnames(mydata.WCG_4)<-c("chrom", "start", "end", "Methyl_transform", "DNase_transform")
# remove x-axis cutoff < -10
mydata.WCG_4<-mydata.WCG_4[with(mydata.WCG_4,mydata.WCG_4$Methyl_transform>-10),]
# Estimation of regression parameters
# fit linear models and carry out regression
model_4<-lm(Methyl_transform~DNase_transform,data=mydata.WCG_4)
# Obtain predicted and residual values and draw figures
...
# combine
if(a_3<0){result4<-paste0("Methyl_transform=",a_2,"XDNase_transform",a_3,"; R^2=",result_r.squared,"; n=",n)}else{result4<-paste0("Methyl_transform=",a_2,"XDNase_transform+",a_3,"; R^2=",result_r.squared,"; n=",n)}
