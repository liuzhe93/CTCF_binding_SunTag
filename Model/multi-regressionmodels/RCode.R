setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/multi-regressionmodels/windowsize1000.max")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/multi-regressionmodels/windowsize1000.avg")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/multi-regressionmodels/windowsize500.max")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/multi-regressionmodels/windowsize500.avg")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/multi-regressionmodels/windowsize300.max")
#setwd("E:/MyProject_YanLab/Project4_CTCFbinding/Model/multi-regressionmodels/windowsize300.avg")
...
# set column names
mydata.GCH_1<-cbind(mydata.GCH_1[,1:3],log(mydata.GCH_1[,4]),mydata.GCH_1[,5],log(mydata.GCH_1[,6]+0.1),log(mydata.GCH_1[,7]+0.1))
colnames(mydata.GCH_1)<-c("chrom", "start", "end", "Methyl_transform", "Repli", "ChIP_transform","DNase_transform")
...
model_1<-lm(Methyl_transform~Repli+ChIP_transform+DNase_transform,data=mydata.GCH_1)
...
# the coefficient of log(ChIP-seq+0.1)
a_1<-round(model_1$coefficients[3],3)
# the coefficient of Repli-seq
a_2<-round(model_1$coefficients[2],3)
# the coefficient of DNase-seq
a_3<-round(model_1$coefficients[4],3)
# constant
a_4<-round(model_1$coefficients[1],3)
# combine
if (a_2>0 & a_3>0 & a_4<0 ) {
result1<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli+",a_3,"XDNase_transform",a_4,"; R^2=",result_r.squared)
} else if (a_2>0 & a_3<0 & a_4>0) {
result1<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
} else if (a_2<0 & a_3>0 & a_4>0) {
result1<-paste0("Methyl_transform=",a_1,"XChIP_transform",a_2,"XRepli+",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
} else if (a_2<0 & a_3<0 & a_4>0) {
...
p1=ggplot()+
	...
	theme(plot.title = element_text(hjust = 0.5,vjust = 1),plot.subtitle = element_text(hjust = 0.5,size=5))+
	expand_limits(x = 0)
...
# set column names
mydata.WCG_2<-cbind(mydata.WCG_2[,1:3],log(mydata.WCG_2[,4]),mydata.WCG_2[,5],log(mydata.WCG_2[,6]+0.1),log(mydata.WCG_2[,7]+0.1))
colnames(mydata.WCG_2)<-c("chrom", "start", "end", "Methyl_transform", "Repli", "ChIP_transform","DNase_transform")
# remove x-axis cutoff < -10
mydata.WCG_2<-mydata.WCG_2[with(mydata.WCG_2,mydata.WCG_2$Methyl_transform>-10),]
# Estimation of regression parameters
# fit linear models and carry out regression
model_2<-lm(Methyl_transform~Repli+ChIP_transform+DNase_transform,data=mydata.WCG_2)
# Obtain predicted and residual values and draw figures
...
result_r.squared<-round(suma$r.squared,3)
# the coefficient of log(ChIP-seq+0.1)
a_1<-round(model_2$coefficients[3],3)
# the coefficient of Repli-seq
a_2<-round(model_2$coefficients[2],3)
# the coefficient of DNase-seq
a_3<-round(model_2$coefficients[4],3)
# constant
a_4<-round(model_2$coefficients[1],3)
# combine
if (a_2>0 & a_3>0 & a_4<0 ) {
result2<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli+",a_3,"XDNase_transform",a_4,"; R^2=",result_r.squared)
} else if (a_2>0 & a_3<0 & a_4>0) {
result2<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
} else if (a_2<0 & a_3>0 & a_4>0) {
result2<-paste0("Methyl_transform=",a_1,"XChIP_transform",a_2,"XRepli+",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
...
# set column names
mydata.GCH_3<-cbind(mydata.GCH_3[,1:3],log(mydata.GCH_3[,4]),mydata.GCH_3[,5],log(mydata.GCH_3[,6]+0.1),log(mydata.GCH_3[,7]+0.1))
colnames(mydata.GCH_3)<-c("chrom", "start", "end", "Methyl_transform", "Repli", "ChIP_transform","DNase_transform")
# remove x-axis cutoff < -10
mydata.GCH_3<-mydata.GCH_3[with(mydata.GCH_3,mydata.GCH_3$Methyl_transform>-10),]
# Estimation of regression parameters
# fit linear models and carry out regression
model_3<-lm(Methyl_transform~Repli+ChIP_transform+DNase_transform,data=mydata.GCH_3)
# Obtain predicted and residual values and draw figures
...
result_r.squared<-round(suma$r.squared,3)
# the coefficient of log(ChIP-seq+0.1)
a_1<-round(model_3$coefficients[3],3)
# the coefficient of Repli-seq
a_2<-round(model_3$coefficients[2],3)
# the coefficient of DNase-seq
a_3<-round(model_3$coefficients[4],3)
# constant
a_4<-round(model_3$coefficients[1],3)
# combine
if (a_2>0 & a_3>0 & a_4<0 ) {
result3<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli+",a_3,"XDNase_transform",a_4,"; R^2=",result_r.squared)
} else if (a_2>0 & a_3<0 & a_4>0) {
result3<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
} else if (a_2<0 & a_3>0 & a_4>0) {
result3<-paste0("Methyl_transform=",a_1,"XChIP_transform",a_2,"XRepli+",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
...
# set column names
mydata.WCG_4<-cbind(mydata.WCG_4[,1:3],log(mydata.WCG_4[,4]),mydata.WCG_4[,5],log(mydata.WCG_4[,6]+0.1),log(mydata.WCG_4[,7]+0.1))
colnames(mydata.WCG_4)<-c("chrom", "start", "end", "Methyl_transform", "Repli", "ChIP_transform","DNase_transform")
# remove x-axis cutoff < -10
mydata.WCG_4<-mydata.WCG_4[with(mydata.WCG_4,mydata.WCG_4$Methyl_transform>-10),]
# Estimation of regression parameters
# fit linear models and carry out regression
model_4<-lm(Methyl_transform~Repli+ChIP_transform+DNase_transform,data=mydata.WCG_4)
# Obtain predicted and residual values and draw figures
...
result_r.squared<-round(suma$r.squared,3)
# the coefficient of log(ChIP-seq+0.1)
a_1<-round(model_4$coefficients[3],3)
# the coefficient of Repli-seq
a_2<-round(model_4$coefficients[2],3)
# the coefficient of DNase-seq
a_3<-round(model_4$coefficients[4],3)
# constant
a_4<-round(model_4$coefficients[1],3)
# combine
if (a_2>0 & a_3>0 & a_4<0 ) {
result4<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli+",a_3,"XDNase_transform",a_4,"; R^2=",result_r.squared)
} else if (a_2>0 & a_3<0 & a_4>0) {
result4<-paste0("Methyl_transform=",a_1,"XChIP_transform+",a_2,"XRepli",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
} else if (a_2<0 & a_3>0 & a_4>0) {
result4<-paste0("Methyl_transform=",a_1,"XChIP_transform",a_2,"XRepli+",a_3,"XDNase_transform+",a_4,"; R^2=",result_r.squared)
