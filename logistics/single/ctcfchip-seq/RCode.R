setwd("E:/MyProject_YanLab/Project4_CTCFbinding/logistics/single/ctcfchip-seq/windowsize1000.max")
...
# set column names
colnames(mydata.GCH_1)<-c("chrom", "start", "end", "Methyl", "ChIP")

mydata.GCH_1$ChIP<-factor(mydata.GCH_1$ChIP,levels = c("no","yes"),order=TRUE)
